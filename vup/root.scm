  ...
  (let* ((version "4.10.0"))
    (package
      ...
      (source
       (origin
         (method url-fetch)
         (uri (string-append "http://lcgpackages.web.cern.ch/lcgpackages/tarFiles/sources/xrootd-" version ".tar.gz"))
         (sha256
          (base32 "0nwr27apz3rzqcs657bgsgydibhr6sswfws12bzyisbjgpi8azzh"))))
      (build-system cmake-build-system)
      (inputs `(("zlib" ,zlib) ("openssl" ,openssl)))
      (home-page "https://xrootd.slac.stanford.edu/")
      (synopsis "The XROOTD project aims at giving high performance, scalable fault tolerant access to data repositories of many kinds.")
  ...
  (let* ((version "0.4.3"))
    (package
      ...
      (source
       (origin
         (method url-fetch)
         (uri (string-append "http://lcgpackages.web.cern.ch/lcgpackages/tarFiles/sources/vdt-" version ".tar.gz"))
         (sha256
          (base32 "1qdc10p4j6jl0as3a8pfvrygxdry2x6izxm8clmihp5v5rhp8mkh"))))
      (build-system cmake-build-system)
      (inputs `(("python" ,python)))
      (arguments '(#:configure-flags '("-DFMA=ON" "-DAVX=ON" "-DAVX2=ON")
  ...
  (let* ((version "1.20"))
    (package
      ...
      (source
       (origin
         (method url-fetch)
         (uri (string-append "ftp://ftp.afterstep.org/stable/libAfterImage/libAfterImage-" version ".tar.gz"))
         (patches (search-patches "libafterimage-ldflags.patch" "libafterimage-libpng15.patch" "header-install.patch"))
         (sha256
          (base32 "125y119fbr3g389nr7yls4i7x5zd5pz7h8qn12k8b21b4xk1h6y5"))))
      (build-system gnu-build-system)
      (inputs `(("zlib" ,zlib) ("librsvg" ,librsvg)))
    ...
    (package
      ...
      (source (origin
                ...
                (uri (git-reference
                      ...
                      (commit (string-append "v" (string-replace-substring version "." "-")))))
                (file-name (git-file-name name version))
                (sha256
                 (base32
                  "1lwr4l73p8isp5ifs9vq06rnjk0wfp3psxf9ih6rbxhrd2k042qm"))))
      (build-system cmake-build-system)
      (inputs `(("xrootd" ,xrootd) ("zstd" ,zstd "lib") ("tbb" ,tbb)
                ("libX11" ,libx11) ("xxhash" ,xxhash) ("lz4" ,lz4) ("freetype" ,freetype)
                ("pcre" ,pcre) ("python" ,python) ("python-numpy" ,python-numpy)
                ("libXpm" ,libxpm) ("libxft" ,libxft) ("libXext" ,libxext)
                ("fftw" ,fftw) ("cfitsio" ,cfitsio) ("openssl" ,openssl)
                ("vdt" ,vdt) ("libxml2" ,libxml2) ("opengl" ,mesa) ("glu" ,glu)
                ("gsl" ,gsl) ("pkg-config" ,pkg-config) ("ftgl" ,ftgl)
      ...
      (synopsis "ROOT: analyzing, storing and visualizing big data, scientifically")
      (description "ROOT: analyzing, storing and visualizing big data, scientifically")
