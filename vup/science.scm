...
(define-public ccfits
  (let ((version "2.5"))
    (package
      ...
      (source (origin
                (method url-fetch)
                (uri (string-append "https://heasarc.gsfc.nasa.gov/fitsio/CCfits/CCfits-" version ".tar.gz"))
                (sha256
                 (base32
      ...
      (synopsis "CCfits is an object oriented interface to the cfitsio library")
...
(define-public cfitsio2
  (package
    ...
    (source
     (origin
       (method url-fetch)
       (uri "http://heasarc.gsfc.nasa.gov/FTP/software/fitsio/c/cfitsio3370.tar.gz")
       (sha256
        (base32 "0fn6361mnm76y33zzczrv2inl8z88n776nnkj4ny9pz4vb39fa09"))))
    (arguments
     `(#:make-flags `("shared")
       #:tests? #f ; no tests
       #:phases
